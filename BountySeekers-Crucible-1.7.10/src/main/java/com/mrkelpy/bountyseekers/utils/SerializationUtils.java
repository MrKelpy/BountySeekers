...
public class SerializationUtils {
    ...
    public static String itemStackToMagBase32(ItemStack item) {
        ...
        try (ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
            ...
            Object ReCrucibleNMSItem = ReBukkit.CraftItemStack.asNMSCopy(item);
            ReCrucibleNMS.NBTCompressedStreamTools.a(ReCrucibleNMS.ItemStack.save(ReCrucibleNMSItem, ReCrucibleNMS.NBTTagCompound.create()), dataOutput);
    ...
    public static ItemStack itemStackFromMagBase32(String data) {
        ...
        try (ByteArrayInputStream inputStream = new ByteArrayInputStream(new BigInteger(data, 32).toByteArray());
            ...
            Object itemData = ReCrucibleNMS.NBTCompressedStreamTools.a(dataInput);
            Object ReCrucibleNMSItemStack = ReCrucibleNMS.ItemStack.createStack(itemData);

            // Return a bukkit copy of the ReCrucibleNMS itemStack.
            return ReBukkit.CraftItemStack.asBukkitCopy(ReCrucibleNMSItemStack);
