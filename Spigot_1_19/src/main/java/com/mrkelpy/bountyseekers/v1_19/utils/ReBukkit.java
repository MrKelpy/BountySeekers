...
public class ReBukkit {
    ...
    public static class CraftItemStack {
        ...
        private static final Class<?> CLASS = com.mrkelpy.bountyseekers.v1_12.utils.ReBukkit.getBukkitClass("inventory.CraftItemStack");
        ...
        public static Object asNMSCopy(ItemStack itemStack) {
            try {
                return CLASS.getMethod("asNMSCopy", new Class[] {ItemStack.class}).invoke(CLASS, itemStack);
        ...
        public static ItemStack asBukkitCopy(Object nmsItemStack) {
            try {
                return (ItemStack) CLASS.getMethod("asBukkitCopy", new Class[] {ReNMS.ItemStack.CLASS}).invoke(CLASS, nmsItemStack);
