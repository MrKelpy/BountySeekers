...
import com.mrkelpy.bountyseekers.v1_12.utils.ReBukkit;
import com.mrkelpy.bountyseekers.v1_12.utils.ReNMS;
...
public class SerializationUtils {
    ...
    public static String itemStackToMagBase32(ItemStack item) {
        ...
        try (ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
            ...
            Object ReNMSItem = com.mrkelpy.bountyseekers.v1_12.utils.ReBukkit.CraftItemStack.asNMSCopy(item);
            com.mrkelpy.bountyseekers.v1_12.utils.ReNMS.NBTCompressedStreamTools.a(com.mrkelpy.bountyseekers.v1_12.utils.ReNMS.ItemStack.b(ReNMSItem, com.mrkelpy.bountyseekers.v1_12.utils.ReNMS.NBTTagCompound.create()), dataOutput);
    ...
    public static ItemStack itemStackFromMagBase32(String data) {
        ...
        try (ByteArrayInputStream inputStream = new ByteArrayInputStream(new BigInteger(data, 32).toByteArray());
            ...
            Object itemData = com.mrkelpy.bountyseekers.v1_12.utils.ReNMS.NBTCompressedStreamTools.a(dataInput);
    ...
    public static String itemStackArrayToBase64(ItemStack[] stackArray) {
        ...
        try (ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
            ...
            for (ItemStack itemStack : stackArray) {
                String base64ItemStack = com.mrkelpy.bountyseekers.v1_12.utils.SerializationUtils.itemStackToMagBase32(itemStack);
    ...
    public static ItemStack[] itemStackArrayFromBase64(String data) {
        ...
        try (ByteArrayInputStream inputStream = new ByteArrayInputStream(Base64Coder.decodeLines(data));
            ...
            for (int i = 0; inventoryContents.length > i; i++) {
                ...
                if (base64Data != null)
                    inventoryContents[i] = com.mrkelpy.bountyseekers.v1_12.utils.SerializationUtils.itemStackFromMagBase32((String) base64Data);
            }
