...
public class InternalConfigs {
    ...
    public static final com.mrkelpy.bountyseekers.v1_12.configuration.InternalConfigs INSTANCE = new com.mrkelpy.bountyseekers.v1_12.configuration.InternalConfigs();
