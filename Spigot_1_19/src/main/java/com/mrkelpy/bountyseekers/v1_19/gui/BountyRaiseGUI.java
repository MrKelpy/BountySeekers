...
import com.mrkelpy.bountyseekers.v1_12.gui.ConfirmationGUI;
import com.mrkelpy.bountyseekers.v1_12.utils.ItemStackUtils;
...
public class BountyRaiseGUI extends ConfirmationGUI {
    ...
    public void onItemPickup(EntityPickupItemEvent event) {
        ...
        if (player == this.benefactor.getPlayer())
